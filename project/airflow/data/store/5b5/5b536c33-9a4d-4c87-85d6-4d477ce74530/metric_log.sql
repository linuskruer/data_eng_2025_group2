ATTACH TABLE _ UUID '8ba3edc5-307e-4893-8620-b82e7d0dab15'
(
    ...
    `ProfileEvent_CreatedHTTPConnections` UInt64 COMMENT 'Total amount of created HTTP connections (counter increase every time connection is created).',
    ...
    `ProfileEvent_ReadWriteBufferFromHTTPPreservedSessions` UInt64 COMMENT 'Number of HTTP sessions that were preserved in ReadWriteBufferFromHTTP.',
    ...
    `ProfileEvent_FilesystemCacheEvictionSkippedFileSegments` UInt64 COMMENT 'Number of file segments skipped for eviction because of being unreleasable',
    ...
    `ProfileEvent_S3QueueCleanupMaxSetSizeOrTTLMicroseconds` UInt64 COMMENT 'Time spent to set file as failed',
    `ProfileEvent_S3QueuePullMicroseconds` UInt64 COMMENT 'Time spent to read file data',
    `ProfileEvent_S3QueueLockLocalFileStatusesMicroseconds` UInt64 COMMENT 'Time spent to lock local file statuses',
    ...
    `ProfileEvent_IOUringSQEsResubmits` UInt64 COMMENT 'Total number of io_uring SQE resubmits performed',
