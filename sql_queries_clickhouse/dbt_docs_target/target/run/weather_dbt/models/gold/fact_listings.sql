        ...
        insert into default.fact_listings__dbt_backup ("item_id", "date_key", "product_type", "location_name", "seller_feedback_score", "marketplace_id", "currency_code", "condition_name", "buying_option", "price", "shipping_cost", "free_shipping", "title_length", "collection_timestamp", "weather_category", "seller_location", "seller_feedback_percentage", "timezone")
